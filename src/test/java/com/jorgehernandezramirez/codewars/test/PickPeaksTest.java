...
import com.jorgehernandezramirez.codewars.PickPeaks;
...
public class PickPeaksTest {
    ...
    public void sampleTests1() {
        Map<String, List<Integer>> map = PickPeaks.getPeaks(new int[]{1,2,3,6,4,1,2,3,2,1});
        System.out.println(Arrays.toString(map.get("pos").toArray()));
        System.out.println(Arrays.toString(map.get("peaks").toArray()));
    }
}
